sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("Jet/ControlTaskChimburArtem/app", ".html");
		...
		return Opa5.extend("Jet.ControlTaskChimburArtem.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["Jet/ControlTaskChimburArtem/localService/mockserver"], function (mockserver) {
